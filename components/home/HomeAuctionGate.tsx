    ...
    >
      ...
      >
        ...
        <GlassCard className="w-full p-8 sm:p-12 md:p-14 rounded-4xl flex flex-col items-center text-center shadow-2xl border border-white/20">
          <motion.h1
            className="text-4xl font-black tracking-tight sm:text-6xl text-white font-display leading-tight uppercase"
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2, duration: 0.8, ease: EASE_OUT_EXPO }}
          >
            {leagueConfig ? leagueConfig.copyPrefixes.auction : 'APL Live Auction Room'}
          </motion.h1>
