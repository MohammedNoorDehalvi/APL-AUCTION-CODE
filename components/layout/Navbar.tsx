    ...
    <header className="fixed top-0 left-0 right-0 z-50 px-4 py-3 transition-all duration-300">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
          {/* Brand Logo */}
          <Link href="/" className="flex items-center gap-3 group" aria-label={`${leagueConfig?.shortName || 'APL'} Auction Home`}>
            ...
            <div className="flex flex-col">
              <span className="font-extrabold text-sm tracking-wider bg-gradient-to-r from-white via-slate-100 to-slate-400 bg-clip-text text-transparent font-display leading-tight uppercase">
                {leagueConfig ? leagueConfig.brandName : 'ASHOKA PREMIER'}
              </span>
              <span className="text-[10px] font-semibold tracking-widest text-cyan-400 uppercase leading-none">
                {leagueConfig ? 'LEAGUE AUCTION' : 'LEAGUE AUCTION'}
              </span>
            </div>
          </Link>
